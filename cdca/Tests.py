...
class TestSwarmControl(unittest.TestCase):
    ...
    #     '''This test needs the following constants to be set to specific values:
    #             SPEED = 1
    #             TIME_STEP = 1
    #             MINIMUM_DISTANCE = 1 
    ...
    #     swarm_controller.visualise_swarm("Cross Collision with Basic Collision Avoidance")
    ...
    #     swarm_controller.detect_potential_collisions()
    #     swarm_controller.visualise_swarm("Parallel Collision with Basic Collision Avoidance")
    ...
    #     swarm_controller.detect_potential_collisions()
    #     swarm_controller.visualise_swarm("Destination Occupied Collision with Basic Collision Avoidance")

    #     self.assertEqual(swarm_controller.drones[0].plan[0][1], 16, '')
    ...
    #     swarm_controller.detect_potential_collisions()s
    ...
    def test_dependency_collision_avoidance_cross_collision(self):
        ...
        plans = [[[[1,1], 5], [[9,9], 3]], [[[9,1], 5], [[1,9], 3]],[[[1,9], 5], [[9,1], 3]], [[[9,9], 5], [[1,1], 3]]] # cross collision
        # plans = [[[[9,1], 1], [[1,1], 3]], [[[1,9], 1], [[1,1], 3]]] # final dest occupied collision
        # plans = [[[[10,10], 5], [[80,80], 3]], [[[50,60], 5], [[10,10], 3]]] # parallel collision
        # plans = [[[[1,1], 5], [[8,8], 3]], [[[5,6], 5], [[1,1], 3]]] # parallel collision
# 
    ...
    #     swarm_controller = Swarm_Control(plans, Potential_Fields_Collision_Avoidance(resolution_factor=4,visualise=True))
    ...
    #     swarm_controller = Swarm_Control(plans, Potential_Fields_Collision_Avoidance())
